...
:---|---|:---:|:---:| ---
0.0 | block with one uncle on etherscan | "0xA385D3", "0x0" | ^same as above| it works|
0.1 | block with no uncle on etherscan | "0xA38377", "0x0" | null | It works
0.2 | block with no uncle on etherscan | "0xA38377", "0x1000" | null | It works
---
# TODO
## geth --http --dev
version 1.10.4-stable
